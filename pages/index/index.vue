		...
		<scroll-view class="data_body" scroll-y :style="{height:scrollHeight}">
			<template v-if="true">
				...
				<view class="friend_operate">
					<view class="title">
						<text class="font-small" style="color:cornflowerblue;">水体参数</text>
					</view>
				...
				<view class="friend_operate">
					...
					<text-block 
					:content="ServiceComment"></text-block>
				</view>
	...
	export default {
		...
		data() {0
			return {
				...
				RankData,
				isRank:true,
				delayload: true, //延时加载图表，否则会出现图表加载完后定位错乱
			}
		},
		onLoad() {
